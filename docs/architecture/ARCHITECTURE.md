...
| **TextualPlanReviewer**        | Implements `IPlanReviewer` using a dual-pane `Textual` TUI (ActionTree/ParameterList) for interactive plan review.               | [TextualPlanReviewer](./adapters/inbound/textual_plan_reviewer.md)                |
