...
*   **File Editing (`edit_file`):** Delegates string manipulation to the `IEditSimulator` and then writes the result to disk, ensuring consistency between preview and execution.
