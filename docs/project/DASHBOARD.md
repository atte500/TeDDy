...
| [08-replace-markdownify-with-trafilatura](./milestones/08-replace-markdownify-with-trafilatura.md)         | `Planned`     | N/A                                                                                                                                                                 | Implement `trafilatura` and Update System                                                                                                                                                                                                                                   |
| [09-llm-client-and-config-service](./milestones/09-llm-client-and-config-service.md)                       | `Planned`     | [Foundational Restructuring](./specs/foundational-restructuring.md)                                                                                                 | Implement Config Service and LLM Client                                                                                                                                                                                                                                     |
...
| [11-refactor-legacy-dtos](./milestones/11-refactor-legacy-dtos.md)                                         | `Planned`     | N/A                                                                                                                                                                 | Refactor `CommandResult` to `ShellOutput`<br>Refactor `SERPReport` to `WebSearchResults`<br>Refactor `ContextResult` to `ProjectContext`                                                                                                                                  |
