...
The report is generated by a unified Jinja2 templating system, with its format and conventions derived directly from the canonical template: `src/teddy_executor/core/services/templates/execution_report.md.j2`.
