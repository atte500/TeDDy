...
| :------------------------------------------------------------------------------------- | :-------- | :------------------------------------------------------------------------------------------------------------------------------------------------------------------ | :--------------------------------------------------------------------------------------------------------------------------------- |
| [09-hexagonal-test-architecture](./milestones/09-hexagonal-test-architecture.md)       | `Planned` | N/A                                                                                                                                                                 | Treating tests as first-class citizens, unified linting rules, and extracting formal Test DSLs/Builders.                           |
