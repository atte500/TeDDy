...
| -------------------------------------------------------------------------------------------- | ------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [08-core-refactoring-and-enhancements](./milestones/08-core-refactoring-and-enhancements.md) | `In Progress` | [New Plan Format](./specs/new-plan-format.md)                                                                                                                       | Refactor Parser and Fix Bug<br>Simplify EXECUTE Action Syntax<br>Implement `trafilatura` (Lenient Defaults)<br>Refactor `CommandResult` to `ShellOutput`<br>Refactor `SERPReport` to `WebSearchResults`<br>Refactor `ContextResult` to `ProjectContext`<br>[17-configure-ci-quality-gates](./slices/17-configure-ci-quality-gates.md) (`In Progress`)<br>Audit and Invert Test Pyramid<br>Remediate High-Complexity Code<br>Refine CLI Help Descriptions<br>Fix Parser Nesting Bug<br>Trim Plan Preamble<br>[18-enhance-cli-user-experience](./slices/18-enhance-cli-user-experience.md) |
| [09-interactive-session-and-config](./milestones/09-interactive-session-and-config.md)       | `Planned`     | [Interactive Session](./specs/interactive-session-workflow.md)<br>[Context Payload](./specs/context-payload-format.md)<br>[Report Format](./specs/report-format.md) | Implement Config Service and LLM Client<br>Session Scaffolding & Core Commands<br>Context-Centric Workflow<br>Core Workflow & Enhanced Interactivity<br>Plan Validation & Automated Re-planning<br>Action Side-Effects & Reporting<br>Agent Collaboration Model<br>Automatic Session Log Generation                                                                                                                                                                                                      |
