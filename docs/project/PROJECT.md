...
| :------------------------------------------------------------------------------------------- | :------------ | :------------------------------------------------------------------------------------------------------------------------------------------------------------------ | :--------------------------------------------------------------------------------------------------------------------------------- |
| [08-core-refactoring-and-enhancements](./milestones/08-core-refactoring-and-enhancements.md) | `In Progress` | [New Plan Format](./specs/new-plan-format.md)                                                                                                                       | Robust Parser, POSIX Shell Pre-processor, DTO Modernization, CI Quality Gates (Coverage/Complexity), Traditional Test Pyramid, and CLI UX Polish. |
