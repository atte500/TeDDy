...
| :------------------------------------------------------------------------------------- | :------------ | :------------------------------------------------------------------------------------------------------------------------------------------------------------------ | :--------------------------------------------------------------------------------------------------------------------------------- |
| [09-hexagonal-test-architecture](./milestones/09-hexagonal-test-architecture.md)       | `In Progress` | N/A                                                                                                                                                                 | Treating tests as first-class citizens, unified linting rules, and extracting formal Test DSLs/Builders.                           |
| [10-interactive-session-and-config](./milestones/10-interactive-session-and-config.md) | `On Hold`     | [Interactive Session](./specs/interactive-session-workflow.md)<br>[Context Payload](./specs/context-payload-format.md)<br>[Report Format](./specs/report-format.md) | Stateful Session Management, Security Scanning (Secrets/Bandit), LLM Integration (LiteLLM), TUI Workflow, and Agent Collaboration. |
