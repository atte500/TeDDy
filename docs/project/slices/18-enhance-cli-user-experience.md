...
- **Multiline Prompt Injection:** The AI's original prompt is prepended to the temporary file as markdown comments, providing the user with context while drafting a response in their external editor.
