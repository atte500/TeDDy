...
- [ ] **Cleanup** - [DEBT] Replace bare MagicMocks in `tests/suites/acceptance/helpers.py` and `tests/suites/unit/core/services/test_action_executor.py` with `register_mock` to comply with project linting rules.
