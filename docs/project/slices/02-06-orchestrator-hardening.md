...
- [x] **Cleanup** - Reorder Implementation Notes in 02-06-orchestrator-hardening.md so that the "Deliverable 3+4: Windows Interactive Prompt Detection" block appears in sequence after Deliverable 2 (Logic – Interactive Prompt Detection), restoring proper deliverable ordering.
...
### Deliverable A: ShellAdapter UNIX Interactive Prompt Detection
...
### Deliverable B: Logic – Interactive Prompt Detection
