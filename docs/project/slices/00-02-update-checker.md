...
- **Permissions Denied for pip:** If `sys.executable -m pip install` fails (e.g., not running in a virtualenv), display a clear error: "Could not upgrade: [error message]. Please run 'uv tool upgrade teddy-cli' manually."
