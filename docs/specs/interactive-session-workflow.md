...
-   **`report.md`**: The factual record of the execution of `plan.md`. It is the immutable output of the `execute` command, generated in the "Rich Report" format. See the [Report Format Specification](./report-format.md) for details.
